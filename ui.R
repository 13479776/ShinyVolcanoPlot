        ...
        sidebarPanel(
            fileInput('file1', 'Choose CSV File',
                      accept=c('text/csv', 
                               ...
                               '.csv')),
            p("Note: The input file should be a ASCII text file (comma, tab, semicolon separated),
                     containing three columns with ID, logFC and P.Value.", " You can download a working example from",
