    ...
    sidebarLayout(
        sidebarPanel(
            ...
            helpText("Note: The input file should be a ASCII text file (comma, tab, semicolon separated),
                     containing three columns with ID, logFC and P.Value.", " You can download an example from",
                     tags$a(href="https://github.com/onertipaday/ShinyVolcanoPlot/data/example.csv","here")),
            tags$p(),
